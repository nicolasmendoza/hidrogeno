# -*- coding: utf-8 -*-
"""
WheaterWatcher es un objeto que actua de Observador y proxy entre
el stream SpaceTime y pipeline.py.
"""
from collections import deque

from ...galaxy.simulator import PlanetPosition
from ...wheater.job import pipeline
from ...db.models import WheaterForeCastModel
...
class WeatherWatcher(object):
    ...
    def __init__(self, lot_size):
        ...
        :param lot_size: :int: número de registros a batear a la db, es un batcher.
        """
    ...
    def flush(self):
        ...
        print(' Hitting database, lot size={}. Sending bulk data and flushing the batcher.'.format(self.lot_size))
